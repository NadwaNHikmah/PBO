...
class Dashboard:
    def __init__(self):
        ...
        self.mahasiswa_menu.add_command(label='Mahasiswa-Persegi', command=lambda: self.new_window("Luas Persegi", FrmPersegi))
        self.mahasiswa_menu.add_command(label='Mahasiswa-Segitiga', command=lambda: self.new_window("Luas Segitiga", FrmSegitiga))
        self.mahasiswa_menu.add_command(label='Mahasiswa-Lingkaran', command=lambda: self.new_window("Luas Lingkaran", FrmLingkaran))
